...
echo nsformat("4b: formats {0:y}; {0:y yes;no}; {1:y}; {1:y yes;no};\n", false, true);
echo nsformat("4c: exception formats {0:p}\n", new Exception('test exception'));
echo nsformat("4d: auto formats {0:a} {1:a} {2:a} {3:a}\n", false, 12, 12333.321, 'text');
echo nsformat("4e: auto formats {0:a} {1:a}\n", [1,2,3,4], new Exception("auto"));
